...
For this analysis we would take a sample pollutant  * Arsenic PM2.5 LC *
...
__Proxy data - Just take 1 Pollutant - Arsenic PM2.5 LC - for each year__
```{r}
...
ggplot(datatidy.pollutant, aes(x = Year, y = Arithmetic.Mean)) + geom_point() + geom_smooth(method="lm") +
  labs(x = "Year", y = "NHE in Billions", title = "Pollutant - Arsenic PM2.5 LC Trend") + theme(plot.title = element_text(size=20, face="bold", vjust=2))
...
_Just take proxy data of NHE since the year 2008, and compare it with the Pollutant [Arsenic PM2.5] data_
```{r}
...
Based on the trend line from this sample data, there appears to be a strong positive linear relationship between the *GDP and NHE* variables.   However from this *limited* sample pollutant data, there appears to be a **weak positive linear relationship between the pollutant and NHE** variables. Also, this relationship may be **coincidental**.Need more analyses with combination of HAPS (pollutants) to gain insights.  
